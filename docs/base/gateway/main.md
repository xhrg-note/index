...
* 协议转换
* 参数转化
* API分组，非常重要，如果不做API分组，假设有人要对10个接口配置QPS是100，难道需要每个都配置一遍吗？如果要改会很麻烦。API分组是必须做的功能。
* 用户权限管理
...
#### 4.2、云上网关
* https://cloud.tencent.com/document/product/649/40197
* https://help.aliyun.com/product/153275.html
